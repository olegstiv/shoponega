                            ...
                            <table class="table table-bordered table-hover">
                                ...
                                <?php if ($menus) { ?>
                                    <?php foreach ($menus as $menu) { ?>
                                        <tr>
                                            <td class="text-center"><?php if (in_array($menu['headermenu_id'], $selected))  { ?>
                                                    <input type="checkbox" name="selected[]" value="<?php echo $menu['headermenu_id']; ?>" checked="checked" />
                                                <?php } else { ?>
                                                    <input type="checkbox" name="selected[]" value="<?php echo $menu['headermenu_id']; ?>" />
                                                <?php } ?></td>
                                            <td class="text-left"><?php echo $menu['name']; ?></td>
                                            <td class="text-left"><?php echo $menu['sort_order']; ?></td>
