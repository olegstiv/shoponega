            ...
            <div class="row">
              ...
              <div class="col-lg-6 col-md-4 col-sm-12">
				...
				<table id="module-headertop" class="table table-striped table-bordered table-hover">
                  <thead>
                    <tr>
                      <td class="text-center"><?php echo $text_headertop; ?></td>
                    </tr>
                  </thead>
                  <tbody>
                    <?php foreach ($layout_modules as $layout_module) { ?>
                  ...
                  <tfoot>
                    <tr>
                      <td class="text-left"><div class="input-group">
                          ...
                          <div class="input-group-btn">
                            <button type="button" onclick="addModule('headertop');" data-toggle="tooltip" title="<?php echo $button_module_add; ?>" class="btn btn-primary btn-sm"><i class="fa fa-plus-circle"></i></button>
                          </div>
                        </div></td>
                    </tr>
                  </tfoot>
				...
				<table id="module-rightbrand" class="table table-striped table-bordered table-hover">
                  <thead>
                    <tr>
                      <td class="text-center"><?php echo $text_rightbrand; ?></td>
                    </tr>
                  </thead>
                  <tbody>
                    <?php foreach ($layout_modules as $layout_module) { ?>
                    <?php if ($layout_module['position'] == 'rightbrand') { ?>
                    <tr id="module-row<?php echo $module_row; ?>">
                      <td class="text-left"><div class="input-group">
                          <select name="layout_module[<?php echo $module_row; ?>][code]" class="form-control input-sm">
                            <?php foreach ($extensions as $extension) { ?>
                  ...
                  <tfoot>
                    <tr>
                      <td class="text-left"><div class="input-group">
                          ...
                          <div class="input-group-btn">
                            <button type="button" onclick="addModule('rightbrand');" data-toggle="tooltip" title="<?php echo $button_module_add; ?>" class="btn btn-primary btn-sm"><i class="fa fa-plus-circle"></i></button>
                          </div>
                        </div></td>
                    </tr>
                  </tfoot>
...
$('#module-column-left, #module-column-right, #module-content-top, #module-content-bottom, #module-footerright,#module-footerleft,#module-headertop , #module-rightbrand').delegate('select[name*=\'code\']', 'change', function() {
...
$('#module-column-left, #module-column-right, #module-content-top, #module-content-bottom, #module-footerright, #module-footerleft ,#module-headertop , #module-rightbrand').trigger('change');
//--></script> 
</div>
<?php echo $footer; ?>