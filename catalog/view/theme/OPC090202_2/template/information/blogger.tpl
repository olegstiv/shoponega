...
<div class="container">
  ...
  <div class="row"><?php echo $column_left; ?>
    ...
    <div id="content" class="<?php echo $class; ?> single-blog"><?php echo $content_top; ?>
      ...
      <legend><?php echo $text_your_comments; ?></legend>
	  ...
	  <div class="block-title"><legend><?php echo $button_comment_add; ?></legend></div>
      <div class="panel panel-default" id="add-comment">
        ...
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" class="form-horizontal">
          ...
          <div class="col-sm-10 buttons text-left"><input class="btn btn-primary" type="submit" value="<?php echo $button_submit; ?>" title="<?php echo $button_submit; ?>" /></div>
        </form>
        <?php } ?>
      </div>
