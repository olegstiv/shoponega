...
$('#button-voucher').on('click', function() {
  $.ajax({
    ...
    success: function(json) {
      ...
      if (json['error']) {
        $('.content-top-breadcum').after('<div class="container"><div class="row"><div class="alert alert-danger"><i class="fa fa-exclamation-circle"></i> ' + json['error'] + '<button type="button" class="close" data-dismiss="alert">&times;</button></div></div></div>');
